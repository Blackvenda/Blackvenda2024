  // Check if the user is already logged in (for example, using a token or session) from local storage
    ...
    if (userLoggedIn) {
		...
		document.getElementById('customer-nail-dd').textContent = localStorage.getItem('userEmail');
        document.getElementById('sign-out-button').style.display = 'block';
        document.querySelectorAll("#singInNew")[0].style.display = "none";
		document.querySelectorAll(".my-orders")[0].style.display = "block";
		document.querySelectorAll(".account-setting")[0].style.display = "block";
    ...
    function signOut() {
		...
		document.querySelectorAll(".account-setting")[0].style.display = 'none'; 
		document.querySelectorAll(".my-orders")[0].style.display = 'none'; 
        document.getElementById('customer-name').textContent = '';
        document.querySelectorAll("#singInNew")[0].style.display = "block";
